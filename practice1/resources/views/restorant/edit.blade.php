          ...
          <ul>
            <form action="{{route('restorants-update', $restorant)}}" method="post">
              <div class="form-group">
                ...
                <input class="form-control" type="text" required name="restorant_city" value={{$restorant->city}}>
                ...
                <input class="form-control" type="text" required name="restorant_working_time" value={{$restorant->working_time}}>
              </div>
              @csrf
              @method('put')
